...
class ItemUsersControllerTest < ActionController::TestCase
  ...
  test "should create item_user" do
    assert_difference('ItemUser.count') do
      post :create, item_user: { item_id: @item_user.item_id, quantity: @item_user.quantity, user_id: @item_user.user_id }
    end
  ...
  test "should update item_user" do
    patch :update, id: @item_user, item_user: { item_id: @item_user.item_id, quantity: @item_user.quantity, user_id: @item_user.user_id }
    assert_redirected_to item_user_path(assigns(:item_user))
  end
